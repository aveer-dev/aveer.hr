  ...
  public: {
    Tables: {
      ...
      appraisal_cycles: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "appraisal_cycles_employee_fkey"
            columns: ["employee"]
            isOneToOne: false
            referencedRelation: "contracts"
            referencedColumns: ["id"]
      ...
      appraisal_email_notifications: {
        Row: {
          appraisal_cycle: number
        ...
        Relationships: [
          {
            foreignKeyName: "appraisal_email_notifications_appraisal_cycle_fkey"
            columns: ["appraisal_cycle"]
            isOneToOne: false
            referencedRelation: "appraisal_cycles"
            referencedColumns: ["id"]
          },
          {
            foreignKeyName: "appraisal_email_notifications_contract_fkey"
            columns: ["contract"]
            isOneToOne: false
            referencedRelation: "contracts"
            referencedColumns: ["id"]
      ...
      appraisal_scheduled_emails: {
        Row: {
          appraisal_cycle: number
          contract: number | null
          created_at: string
          email_data: Json
          email_type: Database["public"]["Enums"]["appraisal_email_type"]
        ...
        Relationships: [
          {
            foreignKeyName: "appraisal_scheduled_emails_appraisal_cycle_fkey"
            columns: ["appraisal_cycle"]
            isOneToOne: false
            referencedRelation: "appraisal_cycles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "appraisal_scheduled_emails_contract_fkey"
            columns: ["contract"]
            isOneToOne: false
            referencedRelation: "contracts"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      check_contract_exists: {
        Args: { p_contract_id: number; p_profile_id: string }
        Returns: boolean
      }
      check_contract_exists_with_org: {
        Args: { p_org: string; p_profile_id: string }
        Returns: boolean
      }
    ...
    Enums: {
      ...
      appraisal_email_type:
        | "appraisal_start_reminder_admin"
        | "appraisal_start_reminder_all"
        | "self_review_reminder_day_before"
        | "self_review_reminder_day_of"
        | "manager_review_reminder_day_before"
        | "manager_review_reminder_day_of"
        | "appraisal_end_reminder_admin"
      appraisal_frequency:
        | "monthly"
        | "bi-monthly"
        | "quarterly"
      ...
      email_status: "pending" | "scheduled" | "sent" | "failed" | "cancelled"
      ...
      recipient_type: "admin" | "employee" | "manager"
